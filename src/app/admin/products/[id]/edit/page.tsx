// Client-side edit form for an existing product.
// Responsibilities:
// - Fetch product data from GET /api/products/:id and populate form
// - Allow updating image via /api/upload and submit updated data via PUT
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert('เกิดข้อผิดพลาดในการแก้ไขสินค้า: ' + data.error);
      }
    } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">แก้ไขข้อมูลสินค้า: {product.name}</p>
      </div>
